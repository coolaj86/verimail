...
(function () {
  ...
  $(function () {
    ...
    $('body').delegate('form.js-verimail-query', 'submit', function (ev) {
      ...
      var formArray = $('form.js-verimail-query').serializeArray()
        , formData = {}
        ;
    ...
    } else if (/#unsubscribe:/.exec(location.hash)) {
      $('.js-verimail-confirm').text("Sorry to lose you, " + location.hash.substr(13) + ".");
    }
  });
